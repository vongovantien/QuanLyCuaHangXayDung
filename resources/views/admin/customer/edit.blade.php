    ...
    <div class="container p-5">
        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Enter the email of the supplier" id="email"
            ...
            <button type="submit" class="btn btn-primary">Create and continute orther</button>
